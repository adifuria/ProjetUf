  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <?php
      ...
      if (isset($_SESSION['id'])){
        ...
        echo '</li>';
        echo '<li class="nav-item active">';
        echo '<a class="nav-link" href="modifier_client.php">Modifier les clients <span class="sr-only">(current)</span></a>';
        echo '</li>';
        echo '<li class="nav-item active">';
        echo '<a class="nav-link" href="view_facts.php">Voir les factures <span class="sr-only">(current)</span></a>';
        echo '</li>';
        echo '<li class="nav-item active">';
        echo '<a class="nav-link" href="modifier_facture.php">Modifier les factures <span class="sr-only">(current)</span></a>';
        echo '</li>';
        echo '</ul>';
